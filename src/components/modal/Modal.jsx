...
const Modal = (props) => {
  const { setShowModal, showModal, setIsEditing} = useContext(MainCtx); 
  ...
  return (
    <div ref={modalRef} className={`modal fixed top-0 left-0 z-10 w-full h-[100%] overflow-auto ${showModal ? "active" : ""}`}>
